...
enum ObjectFactoryType {
  ...
  BINARY_CHAR_OBJECT        (BINARY       , Character.class     ,  "CharObject"     ,  5),
  BINARY_CHAR               (BINARY       , Character.TYPE      ,  "Char"           ,  6),
  ...
  VARBINARY_CHAR_OBJECT     (VARBINARY    , Character.class     ,  "CharObject"     ,  5),
  VARBINARY_CHAR            (VARBINARY    , Character.TYPE      ,  "Char"           ,  6),
  ...
  LONGVARBINARY_CHAR_OBJECT (LONGVARBINARY, Character.class     ,  "CharObject"     ,  5),
  LONGVARBINARY_CHAR        (LONGVARBINARY, Character.TYPE      ,  "Char"           ,  6),
